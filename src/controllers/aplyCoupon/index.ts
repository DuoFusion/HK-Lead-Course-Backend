...
import { countData, getData, getFirstMatch } from "../../helper/database_service";
...
export const addCoupon = async (req, res) => {
    ...
    try {
        ...
        let isExist = await getFirstMatch(couponCodeModel, { code: body.code, isDeleted: false }, {}, { lean: true });
